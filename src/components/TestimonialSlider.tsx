                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-sm flex flex-col justify-between min-h-[290px] relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 pt-3.5 border-t border-slate-100 relative z-10">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-[#1A7A4C] font-semibold truncate">{testi.role}</p>
                      <p className="text-[10px] text-[#6B7280] truncate">{testi.year}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="flex items-center gap-3.5 pt-4 border-t border-slate-100">
              ...
              <div>
                ...
                <p className="text-xs text-[#1A7A4C] font-semibold">{testi.role}</p>
                <p className="text-[11px] text-[#6B7280]">{testi.year}</p>
              </div>
            </div>
          </div>
        ))}
