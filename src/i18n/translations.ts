...
export const TRANSLATIONS: Record<Language, Translations> = {
  id: {
    ...
    formPhone: 'Nomor Telepon / Kontak *',
    ...
    formSuccessWa: 'Konfirmasi via Email Resmi',
    formSuccessNew: 'Kirim Pengajuan Baru',

    // Contact Page
    contactHeaderBadge: 'Layanan Informasi Publik',
    contactHeaderTitle: 'Hubungi BIMKER LKROBO',
    contactHeaderDesc: 'Kami siap melayani pertanyaan seputar produk warga binaan, pembelian di Shopee, kerja sama industri, maupun kunjungan studi tiru bimbingan kerja.',
    ...
    whatsappCenter: 'Pusat Informasi & Layanan',
    ...
    formSentSuccessDesc: 'Terima kasih telah menghubungi Bimbingan Kerja Lapas Kerobokan Bali. Kami akan membalas via email atau kontak telepon yang Anda sediakan.',
    ...
    waAskProduct: 'Tanya Produk & Pemesanan Shopee',
    waAskPartnership: 'Informasi Kemitraan / Maklon',
    waOpenChat: 'Hubungi Kontak Resmi',
  ...
  en: {
    ...
    formPhone: 'Phone / Contact Number *',
    ...
    formSuccessWa: 'Confirmation via Official Email',
    ...
    contactHeaderDesc: 'We are ready to assist you with inquiries regarding inmate creations, Shopee purchases, industry partnerships, and prison benchmark visits.',
    ...
    whatsappCenter: 'Information & Services Center',
    ...
    formSentSuccessDesc: 'Thank you for reaching out to Kerobokan Prison Vocational Guidance. We will reply to your email or contact phone number shortly.',
    ...
    waAskProduct: 'Inquire About Products & Shopee Orders',
    waAskPartnership: 'Partnership / Manufacturing Inquiries',
    waOpenChat: 'Contact Official Channels',
